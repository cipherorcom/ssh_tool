...
green "节点订阅内容已生成在 /etc/sing-box/sub.txt 文件中。"
green "你可以使用 'cat /etc/sing-box/sub.txt' 命令查看，并手动导入到客户端。\n"
yellow "\n==========================================================================================\n"
}
...
check_nodes() {
    ...
    green "\n节点订阅内容保存在: ${purple}/etc/sing-box/sub.txt${re}"
    green "使用 'cat /etc/sing-box/sub.txt' 查看并手动导入客户端。\n"
}
